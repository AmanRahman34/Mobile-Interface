...
mainhome:
    ...
    go:
        ...
        puts("\n\n Press R if you want to go to main menu");
        puts(" Press any key if you want to go quit\n");
        if (toupper(getch()) == 'Y' || toupper(getch()) == 'y')
            goto home;
        else if (toupper(getch()) == 'R' || toupper(getch()) == 'r')
        {
